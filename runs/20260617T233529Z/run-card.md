# Run `20260617T233529Z` — eval

- **Created (UTC):** 2026-06-17T23:35:29.853688+00:00
...
```json
{
  ...
  "device": "cuda",
  "dtype": "bfloat16",
  "note": "phase4 jetson F16 deploy gate (15W, clocks locked, single-slot no-cache)",
...
```json
{
  ...
  "n": 439,
  "parse_rate": 1.0,
  "iou_gate_pass_rate": 0.621867881548975,
  "mean_iou": 0.4661183713764769,
  "center_std": 218.1606293586703
}
```
