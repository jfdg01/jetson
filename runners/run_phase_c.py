...
Usage (Branch-1 gate — no Gazebo needed):
    python runners/run_phase_c.py --inject-oracle [--dry-run] [--runs N]

Usage (live VLM + Gazebo — requires Gazebo Harmonic installed):
    python runners/run_phase_c.py --expression "the vehicle" [--dry-run]

Outputs:
    experiments/2026-06-14-stage1-baseline/phase-c-vlm.md  (metrics filled in)
    experiments/raw/phase-c-<timestamp>-run<N>.csv
...
Pre-registration: experiments/2026-06-14-stage1-baseline/phase-c-vlm.md
"""
...
def main():
    ...
    parser.add_argument("--out-dir",     default=None,
                        help="Override campaign output directory (default: experiments/2026-06-14-stage1-baseline). "
