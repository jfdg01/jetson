...
```bash
for c in runners/campaigns/2026-06-13-model-capability-sweep/runcards/*.md; do
  printf "%-34s %s\n" "$(basename "$c")" "$(grep -m1 '^status:' "$c" | awk '{print $2}')"
done
```

Design / RQs / hypotheses: [`experiments/2026-06-13-model-capability-sweep.md`](../../../experiments/2026-06-13-model-capability-sweep.md).
...
# or a single unit:
runners/run-unit.sh runners/campaigns/2026-06-13-model-capability-sweep/runcards/01-qwen2.5-0.5b-instruct.md
```
