...
scp jetson:/tmp/msweep01_tegra.log experiments/raw/2026-06-13_msweep01_tegra.log
cp /tmp/msweep01_bench.csv experiments/raw/2026-06-13_msweep01_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `experiments/raw/2026-06-13_msweep01_tegra.log` and `experiments/raw/2026-06-13_msweep01_bench.csv` saved.
