...
Protocol pre-registered in experiments/2026-06-14-gemma-family-sweep/README.md

Run from the repo root:
    python runners/run_gemma_sweep.py
...
def run_footprint_mode(g5_ngl: int) -> None:
    ...
    placeholder = (
        "*(populated by `python runners/run_gemma_sweep.py --footprint`; raw verbose load logs in\n"
        "`./raw/*_footprint.txt`)*"
    )
