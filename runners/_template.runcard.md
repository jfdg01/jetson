...
campaign: <campaign-slug>            # matches experiments/<date>-<campaign>.md
...
> `CLAUDE.md` + this card. See `runners/README.md` for the methodology.
...
# 7. Pull logs back to experiments/raw/
```

## Output contract  (all of these, before you stop)
- [ ] Raw logs → `experiments/raw/<date>_<unit_id>_*.{log,csv}`
