...
Usage:
  ...
  python runners/run_stage3_export.py [--ft-dir ./smolvlm_ft3] [--dry-run]
"""
...
STAGE3_RESULTS_DIR = Path(__file__).parent.parent / "experiments/2026-06-16-stage3-refcoco-finetune"
...
def step4_phase_a(dry_run: bool):
    ...
    cmd = [
        sys.executable, "runners/run_grounding_probe.py",
...
def step5_phase_c(dry_run: bool):
    ...
    cmd = [
        sys.executable, "runners/run_phase_c.py",
        "--vlm-model",     JETSON_GGUF_PATH,
        "--coord-format",  "S3",
        "--out-dir",       str(STAGE3_RESULTS_DIR),
    ]
