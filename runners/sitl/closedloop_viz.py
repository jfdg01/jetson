...
dev box or the Orin.
    ...
    .venv-ft/bin/python runners/sitl/closedloop_viz.py            # self-check + GIF
    .venv-ft/bin/python runners/sitl/closedloop_viz.py --out /tmp/closedloop.gif
"""
import argparse
import os
import sys
...
sys.path.insert(0, os.path.join(here, ".."))        # runners/ (run_t3)
