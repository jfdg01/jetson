...
| Máquina que produjo la cifra | Afirmaciones (de 71) |
|---|---|
| **ambas** (anclaje VLM en la Orin, arrastre SAM2 en la 3090 con tope de tasa) | 48 |
...
- **[`thesis/stats-report.md`](thesis/stats-report.md)** — las 71 afirmaciones del registro, con su prueba exacta, su máquina y sus salvedades. **Once** sobreviven a la corrección de Holm por Parte —la familia adoptada en R-30— y **nueve** en familia global; 24 nunca tuvieron nada que contrastar y 10 llevaban una puerta que ningún resultado posible habría superado. El reparto completo, en ocho categorías disjuntas, está en la sección «Qué sobrevive» del informe.
