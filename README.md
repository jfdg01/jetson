...
| Máquina que produjo la cifra | Afirmaciones (de 72) |
|---|---|
| **ambas** (anclaje VLM en la Orin, arrastre SAM2 en la 3090 con tope de tasa) | 48 |
| RTX 3090 (ablaciones, referencia de fidelidad HF bf16, simulador, generación de escenas) | 16 |
