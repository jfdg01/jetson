...
Usage:
    ...
    python experiments/run_phase_b.py [--dry-run] [--runs N] [--duration S]

Outputs:
    results/2026-06-14-stage1-baseline/phase-b-sitl.md  (metrics table filled in)
    results/raw/phase-b-<timestamp>-run<N>.csv          (per-frame telemetry)
...
# Ensure experiments/ package is importable regardless of cwd
