...
draws them. Deterministic — same GIF on the dev box or on the Orin.
    ...
    .venv-ft/bin/python experiments/sitl/permanence_viz.py            # self-check + GIF
    .venv-ft/bin/python experiments/sitl/permanence_viz.py \
        --clip results/2026-06-18-t1-temporal-contract/clips/crossing_occlusion \
