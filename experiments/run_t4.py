...
Self-check (no device): `.venv-ft/bin/python experiments/run_t4.py` runs the
deterministic asserts. Device run: `.venv-ft/bin/python experiments/run_t4.py --phase all`.
"""
...
# Dev-box (RTX 3090) baselines recorded in results/2026-06-18-t0-cadence/README.md,
