# Run `20260703T095916Z` — phase3a-sitl-integrated

- **Created (UTC):** 2026-07-03T09:59:16.168184+00:00
...
```json
{
  "trial": {
    ...
    "carry_px_err_mean": 32.6,
    "carry_frames": 1038,
    "recovered_after_occlusion": true,
    "twin": {
      "mode": "escort",
      "id_switch_s": 22.28,
      "frac_box_closer_distractor": 0.37,
      "n_boxed_twin_frames": 1038,
      "final_d_true_m": 4.18,
      "final_d_dist_m": 0.41,
