...
`experiments/2026-06-25-roi-crop-anchor/` proved (offline, HF bf16, RefDrone) that a tight
...
- **Live numbers ≠ the RefDrone benchmark.** Per-image latency depends on the upload's
  ...
  *shape* (crop → cheaper prefill, tighter box), with `experiments/2026-06-25-roi-crop-anchor/`
