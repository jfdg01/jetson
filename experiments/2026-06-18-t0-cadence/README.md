...
**Charter:** [`experiments/2026-06-18-part3-charter/README.md`](../2026-06-18-part3-charter/README.md)
...
`runners/run_t0_cadence.py --phase {a,b,c,d,all}` — reuses `JetsonBackend`
(deploy path, T0a), `runners/sitl/bytetrack.py` (T0b), and
`runners/sitl/oracle_bbox.py` (T0c/d). Raw tegrastats logs land in
`experiments/raw/`.
...
T0a from the on-Orin post-parser-fix run (`experiments/raw/t0-results-20260618T113850.json`,
tegrastats `experiments/raw/t0a-tegrastats-20260618T113636.log`); T0b/c/d re-run locally
same-turn (RTX 3090 host) to supersede a stale 11:28 dynamics JSON that carried a
10 m px-velocity bug. Authoritative combined: `experiments/raw/t0-results-combined-authoritative.json`.
