...
Pre-registration (results/stage3-refcoco-finetune/README.md): "Does the grounding
...
Usage:
  ...
  python experiments/run_stage3_g3_parity.py [--n-sample 100] [--dry-run]
"""
...
STAGE3_RAW = Path(__file__).parent.parent / "results/stage3-refcoco-finetune/raw"
