...
**From Part I (`runners/sitl/`) — a working SITL follow stack already exists:**
...
gate is green AND documented in `experiments/` + `RESULTS.md` + `DECISIONS.md` in the same
...
- **Document every result in `experiments/` + `RESULTS.md` + `DECISIONS.md` the same turn.**
