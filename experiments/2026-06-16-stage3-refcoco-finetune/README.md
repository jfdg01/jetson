...
python runners/run_stage3_finetune.py --dry-run          # verify model+LoRA+collate
python runners/run_stage3_finetune.py                     # ~10h, 50k samples, 1 epoch
python runners/run_stage3_finetune.py --eval-only ./smolvlm_ft3   # re-eval merged ckpt
```
