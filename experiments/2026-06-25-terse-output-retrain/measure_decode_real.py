...
Run: source .venv-ft/bin/activate && python experiments/2026-06-25-terse-output-retrain/measure_decode_real.py
"""
import json
...
with open("experiments/2026-06-25-terse-output-retrain/decode_real.json", "w") as f:
