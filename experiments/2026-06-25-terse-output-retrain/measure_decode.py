...
Replicates the T0a 512-anchor measurement (experiments/2026-06-18-t0-cadence) byte-for-byte
...
Run: source .venv-ft/bin/activate && python experiments/2026-06-25-terse-output-retrain/measure_decode.py
"""
import json
import sys
...
out_path = "experiments/2026-06-25-terse-output-retrain/decode_timing.json"
