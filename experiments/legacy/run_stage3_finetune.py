...
collapse (IoU@0.25 = 1%). See results/stage3-refcoco-finetune/README.md for the
...
Run:   source .venv-ft/bin/activate && python experiments/run_stage3_finetune.py [opts]
...
def train(args):
    ...
    loss_csv_path = Path("results/stage3-refcoco-finetune/raw/train_loss.csv")
    iou_csv_path  = Path("results/stage3-refcoco-finetune/raw/eval_iou.csv")
