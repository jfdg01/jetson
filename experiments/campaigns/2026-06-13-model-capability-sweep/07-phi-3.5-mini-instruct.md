...
scp jetson:/tmp/msweep07_tegra.log results/raw/2026-06-13_msweep07_tegra.log
cp /tmp/msweep07_bench.csv results/raw/2026-06-13_msweep07_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep07_tegra.log` and `results/raw/2026-06-13_msweep07_bench.csv` saved.
