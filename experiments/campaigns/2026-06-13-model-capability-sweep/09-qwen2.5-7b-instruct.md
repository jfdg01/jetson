...
scp jetson:/tmp/msweep09_tegra.log results/raw/2026-06-13_msweep09_tegra.log
cp /tmp/msweep09_bench.csv results/raw/2026-06-13_msweep09_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep09_tegra.log` and `results/raw/2026-06-13_msweep09_bench.csv` saved.
