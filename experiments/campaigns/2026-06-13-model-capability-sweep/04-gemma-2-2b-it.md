...
scp jetson:/tmp/msweep04_tegra.log results/raw/2026-06-13_msweep04_tegra.log
cp /tmp/msweep04_bench.csv results/raw/2026-06-13_msweep04_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep04_tegra.log` and `results/raw/2026-06-13_msweep04_bench.csv` saved.
