...
scp jetson:/tmp/msweep05_tegra.log results/raw/2026-06-13_msweep05_tegra.log
cp /tmp/msweep05_bench.csv results/raw/2026-06-13_msweep05_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep05_tegra.log` and `results/raw/2026-06-13_msweep05_bench.csv` saved.
