...
scp jetson:/tmp/msweep08_tegra.log results/raw/2026-06-13_msweep08_tegra.log
cp /tmp/msweep08_bench.csv results/raw/2026-06-13_msweep08_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep08_tegra.log` and `results/raw/2026-06-13_msweep08_bench.csv` saved.
