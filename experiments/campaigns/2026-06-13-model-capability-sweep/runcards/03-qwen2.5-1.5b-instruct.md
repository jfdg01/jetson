...
scp jetson:/tmp/msweep03_tegra.log results/raw/2026-06-13_msweep03_tegra.log
cp /tmp/msweep03_bench.csv results/raw/2026-06-13_msweep03_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep03_tegra.log` and `results/raw/2026-06-13_msweep03_bench.csv` saved.
