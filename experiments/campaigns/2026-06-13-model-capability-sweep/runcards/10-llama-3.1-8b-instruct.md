...
scp jetson:/tmp/msweep10_tegra.log results/raw/2026-06-13_msweep10_tegra.log
cp /tmp/msweep10_bench.csv results/raw/2026-06-13_msweep10_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep10_tegra.log` and `results/raw/2026-06-13_msweep10_bench.csv` saved.
