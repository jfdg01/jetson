...
scp jetson:/tmp/msweep02_tegra.log results/raw/2026-06-13_msweep02_tegra.log
cp /tmp/msweep02_bench.csv results/raw/2026-06-13_msweep02_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep02_tegra.log` and `results/raw/2026-06-13_msweep02_bench.csv` saved.
