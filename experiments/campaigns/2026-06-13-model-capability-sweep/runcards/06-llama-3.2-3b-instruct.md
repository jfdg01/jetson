...
scp jetson:/tmp/msweep06_tegra.log results/raw/2026-06-13_msweep06_tegra.log
cp /tmp/msweep06_bench.csv results/raw/2026-06-13_msweep06_bench.csv
```

## Output contract  (all of these, before you stop)
- [ ] `results/raw/2026-06-13_msweep06_tegra.log` and `results/raw/2026-06-13_msweep06_bench.csv` saved.
