...
**Prereq:** T0–T3 gates PASS. **Harness:** `runners/run_t4.py`.
...
## Results (Orin Nano 8 GB, 15 W — `runners/run_t4.py --phase all`)
...
```
.venv-ft/bin/python runners/run_t4.py            # deterministic budget-logic self-check
.venv-ft/bin/python runners/run_t4.py --phase all # on the Orin (ssh jetson, 15 W)
```
...
Raw: `experiments/2026-06-24-t4-deployment/t4-results-20260624T183835.json`.
