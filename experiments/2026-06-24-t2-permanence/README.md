...
memoryless baseline (`experiments/2026-06-18-t1-temporal-contract/`, DECISIONS 2026-06-18T15:30).
...
## Mechanism (`runners/sitl/reid_policy.py`)
...
`.venv-ft/bin/python runners/sitl/reid_policy.py --score <clip_dir> --snr <S>`.
...
```
.venv-ft/bin/python runners/sitl/reid_policy.py    # reproducibility, beats-baseline, frontier
.venv-ft/bin/python runners/sitl/clip_recorder.py  # baseline + refactored §6 assembly
