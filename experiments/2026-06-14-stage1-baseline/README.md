...
| Artifact | Location |
|---|---|
| This plan (pre-registered) | `experiments/2026-06-14-stage1-baseline/README.md` |
| Phase 0 smoke-test notes | `experiments/2026-06-14-stage1-baseline/phase-0-smoke-tests.md` |
| Phase A results | `experiments/2026-06-14-stage1-baseline/phase-a-grounding-probe.md` |
| Phase B results | `experiments/2026-06-14-stage1-baseline/phase-b-sitl.md` |
| Phase C results | `experiments/2026-06-14-stage1-baseline/phase-c-vlm-in-loop.md` |
| Grounding probe script | `runners/run_grounding_probe.py` |
