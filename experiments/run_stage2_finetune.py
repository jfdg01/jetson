...
Run:   source .venv-ft/bin/activate && python experiments/run_stage2_finetune.py [opts]
...
def train(args):
    ...
    loss_csv_path = Path("results/stage2-finetune/raw/train_loss.csv")
    iou_csv_path  = Path("results/stage2-finetune/raw/eval_iou.csv")
