...
`runners/sitl/permanence_viz.py` — deterministic side-by-side animation from the T1
...
```bash
.venv-ft/bin/python runners/sitl/permanence_viz.py            # → experiments/2026-06-24-t2-permanence/permanence.gif
.venv-ft/bin/python runners/sitl/permanence_viz.py --selfcheck  # asserts it tells the true T2 story
```
