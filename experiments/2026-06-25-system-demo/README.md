...
result, in `experiments/2026-06-24-t3-closed-loop/`). Permanence A/B (T2) and closed-loop
...
for s in "uav0000182_00000_v:the black SUV in the middle of the road:black-suv" \
  ...
  python -m grounding.deploy.video \
    ...
    --caption "$cap" --track --out experiments/2026-06-25-system-demo/clips/$name.mp4
done
