...
sys.path.insert(0, str(ROOT / "experiments"))  # parsers, run_t0_cadence helpers
...
from experiments.run_t0_cadence import REMOTE_MMPROJ, REMOTE_MODEL, _timed_anchor_post
