...
| Oracle bbox module | `experiments/sitl/oracle_bbox.py` | in-repo |
| ByteTrack | `experiments/sitl/bytetrack.py` | in-repo |
| Cascade PID | `experiments/sitl/cascade_pid.py` | in-repo |
| pymavlink offboard | `experiments/sitl/offboard.py` | in-repo |
| End-to-end runner | `experiments/run_phase_b.py` | in-repo |
...
- [x] Oracle bbox module written and unit-tested — 5/5 tests pass (`experiments/sitl/oracle_bbox.py`) (2026-06-15)
- [x] ByteTrack implemented and unit-tested — 4/4 tests pass (`experiments/sitl/bytetrack.py`) (2026-06-15)
- [x] Cascade PID written and unit-tested — 4/4 tests pass (`experiments/sitl/cascade_pid.py`) (2026-06-15)
- [x] pymavlink offboard module written (`experiments/sitl/offboard.py`) (2026-06-15)
- [x] ArduRover SITL runs alongside ArduCopter SITL (ports 5760/5770) — confirmed by dry-run (2026-06-15)
- [x] End-to-end runner `experiments/run_phase_b.py` dry-run passed: 20.2 Hz, 0 track losses (2026-06-15)
