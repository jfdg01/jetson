...
**Date:** TBD (2026-06-16)  
**Script:** `experiments/run_grounding_probe.py --vlm-model /home/jfdg/models/smolvlm_ft_q8_0.gguf`  
**Raw output:** `results/stage2-finetune/raw/phase_a_rerun_stdout.log` (to be captured)
...
*(Copy from results/2026-06-XX-phase-a/README.md once confirmed)*
