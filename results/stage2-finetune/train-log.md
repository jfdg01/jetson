...
**Script:** `experiments/run_stage2_finetune.py`  
**Raw log:** `results/stage2-finetune/raw/train_stdout.log`
...
Full step-by-step log: `results/stage2-finetune/raw/train_stdout.log`  
Full step loss CSV: `results/stage2-finetune/raw/train_loss.csv`
...
| CSV output bug | CSVs written to `data/VisDrone2019-DET/results/…` instead of `results/stage2-finetune/raw/`; moved post-hoc (path resolved relative to visdrone_dir instead of repo root — bug in `iou_csv_path = Path("results/…")` when cwd was different) |
...
Eval CSV: `results/stage2-finetune/raw/eval_iou.csv`
