...
**Status:** OPEN (started 2026-06-18). T1b (temporal contract) implemented &
pytest-locked this turn; T1a (scored SITL clip set) in progress.
...
- **2026-06-18 — T1b done.** Added the §6 temporal primitives to
  ...
  `tests/test_contract.py`. `make test` green (see Decisions below). T1a clip set next.
