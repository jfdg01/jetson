...
Usage:
  ...
  python results/2026-06-30-whole-frame-resolution/roi_sr_probe.py \
      --model ./experiments/runs/v2/phase3-terse100eos-1024 --n 150

Self-check (no model, no GPU):
  python results/2026-06-30-whole-frame-resolution/roi_sr_probe.py --selfcheck
"""
...
def main():
    ...
    p.add_argument("--model", default="./experiments/runs/v2/phase3-terse100eos-1024",
