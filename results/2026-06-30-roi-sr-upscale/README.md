...
**Spine:** `./experiments/runs/v2/phase3-terse100eos-1024` (0–100 coords, matches the
...
python results/2026-06-30-roi-sr-upscale/roi_sr_probe.py \
    --model ./experiments/runs/v2/phase3-terse100eos-1024 --side 400 --feed 1024 --n 0
